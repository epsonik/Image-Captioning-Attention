...
def evaluate(encoder, decoder, caption_model, beam_size: int) -> float:
    ...
    loader = DataLoader(
        CaptionDataset(
            os.path.join(data_f,
                         "output/DenseNet201_glove300_decoder_dim_512_attention_dim_128_ft_embeddings_true_fine_tune_encoder_false"),
            data_name, 'test',
...
if __name__ == '__main__':
    ...
    configs = dict()
    output_path2 = [
        "best_checkpoint_DenseNet201_glove300_decoder_dim_512_attention_dim_128_ft_embeddings_true_fine_tune_encoder_false-epoch-49.pth.tar"
    ]
    output_path = ["DenseNet201_glove300_decoder_dim_512_attention_dim_128_ft_embeddings_true_fine_tune_encoder_false"]
