...
class DenseNet161(nn.Module):
    ...
    def __init__(self, encoded_image_size: int = 7):
        ...
        self.densenet161 = nn.Sequential(*modules)
    ...
    def forward(self, images: torch.Tensor) -> torch.Tensor:
        ...
        """
        feature_map = self.densenet161(images)  # (batch_size, 2048, image_size/32, image_size/32)
    ...
    def fine_tune(self, fine_tune: bool = True) -> None:
        ...
        for module in list(self.densenet161.children())[0][4:]:
            for param in module.parameters():
                param.requires_grad = fine_tune


class AttentionEncoderDenseNet161(nn.Module):
    """
    ...
    def __init__(self, encoded_image_size: int = 7) -> None:
        super(AttentionEncoderDenseNet161, self).__init__()
        self.CNN = DenseNet161(encoded_image_size)
...
class EncoderDenseNet161(nn.Module):
    """
    Implementation of the encoder proposed in paper [1].
    ...
    def __init__(self, encoded_image_size: int = 7, embed_dim: int = 512) -> None:
        super(EncoderDenseNet161, self).__init__()
        self.CNN = DenseNet161(encoded_image_size)
...
class AdaptiveAttentionEncoderDenseNet161(nn.Module):
    """
    Implementation of the encoder proposed in paper [1].
    ...
    def __init__(
        ...
        super(AdaptiveAttentionEncoderDenseNet161, self).__init__()
        self.CNN = DenseNet161(encoded_image_size)
        self.avg_pool = nn.AvgPool2d(
            kernel_size = encoded_image_size,
            stride = encoded_image_size
