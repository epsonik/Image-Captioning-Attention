...
class ResNet152(nn.Module):
    ...
    def forward(self, images: torch.Tensor) -> torch.Tensor:
        ...
        """
        feature_map = self.resnet152(images)  # (batch_size, 2048, image_size/32, image_size/32)
    ...
    def fine_tune(self, fine_tune: bool = True) -> None:
        ...
        for module in list(self.resnet152.children())[5:]:
...
class EncoderResNet152(nn.Module):
    ...
    def __init__(self, encoded_image_size: int = 7, embed_dim: int = 512) -> None:
        ...
        self.CNN = ResNet152(encoded_image_size)
...
class AdaptiveAttentionEncoderResNet152(nn.Module):
    """
    Implementation of the encoder proposed in paper [1].
    ...
    def __init__(
        ...
        super(AdaptiveAttentionEncoderResNet152, self).__init__()
        self.CNN = ResNet152(encoded_image_size)
        self.avg_pool = nn.AvgPool2d(
            kernel_size = encoded_image_size,
            stride = encoded_image_size
