...
class DenseNet121(nn.Module):
    ...
    def forward(self, images: torch.Tensor) -> torch.Tensor:
        ...
        """
        feature_map = self.densenet121(images)  # (batch_size, 2048, image_size/32, image_size/32)
    ...
    def fine_tune(self, fine_tune: bool = True) -> None:
        ...
        for module in list(self.densenet121.children())[0][4:]:
            for param in module.parameters():
                param.requires_grad = fine_tune


class AttentionEncoderDenseNet121(nn.Module):
    """
    ...
    def __init__(self, encoded_image_size: int = 7) -> None:
        super(AttentionEncoderDenseNet121, self).__init__()
...
class EncoderDenseNet121(nn.Module):
    """
    Implementation of the encoder proposed in paper [1].
    ...
    def __init__(self, encoded_image_size: int = 7, embed_dim: int = 512) -> None:
        super(EncoderDenseNet121, self).__init__()
        self.CNN = DenseNet121(encoded_image_size)
