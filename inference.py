...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_folder', type=str, default='/home/bartosiewicz/mateusz/Image-Captioning-Attention/assets/make-weights',
                        help='Path to folder containing images')
    parser.add_argument('--model_folder', type=str, default='/home/bartosiewicz/mateusz/Image-Captioning-Attention/data/output/t',
                        help='Path to folder containing model checkpoints')
    parser.add_argument('--wordmap_path', type=str, default='/home/bartosiewicz/mateusz/Image-Captioning-Attention/data/evaluation/wordmap.json',
