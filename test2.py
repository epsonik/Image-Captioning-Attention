...
word_map_file = os.path.join(data_f,
                             "output/att2all_DenseNet121_decoder_dim_512_fine_tune_encoder_false_fine_false_embeddings_false/wordmap.json")
...
def evaluate(encoder, decoder, caption_model, beam_size: int) -> float:
    ...
    loader = DataLoader(
        CaptionDataset(
            os.path.join(data_f,
                         'output/att2all_DenseNet121_decoder_dim_512_fine_tune_encoder_false_fine_false_embeddings_false'),
            data_name, 'test',
...
if __name__ == '__main__':
    ...
    configs = dict()
    output_path2 = [
    "best_checkpoint_att2all_DenseNet121_decoder_dim_512_fine_tune_encoder_false_fine_false_embeddings_false-epoch-13.pth.tar"]
    output_path = ["att2all_DenseNet121_decoder_dim_512_fine_tune_encoder_false_fine_false_embeddings_false"]
