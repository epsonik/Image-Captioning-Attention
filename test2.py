...
def evaluate(encoder, decoder, caption_model, beam_size: int) -> float:
    ...
    loader = DataLoader(
        CaptionDataset(
            os.path.join(data_f,
                         'output/adaptive_InceptionV3_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true'),
            data_name, 'test',
...
if __name__ == '__main__':
    ...
    output_path2 = [
        ...
        "best_checkpoint_adaptive_InceptionV3_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false-epoch-9.pth.tar"]
    output_path = ["adaptive_InceptionV3_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true"]
