...
word_map_file = os.path.join(data_f,
                             "output/show_tell_InceptionV3_decoder_dim_512_fine_tune_encoder_false_fine_false_embeddings_true/wordmap.json")
...
def evaluate(encoder, decoder, caption_model, beam_size: int) -> float:
    ...
    loader = DataLoader(
        CaptionDataset(
            os.path.join(data_f,
                         'output/show_tell_InceptionV3_decoder_dim_512_fine_tune_encoder_false_fine_false_embeddings_true'),
            data_name, 'test',
...
if __name__ == '__main__':
    ...
    configs = dict()
    output_path2 = [
    "best_checkpoint_show_tell_InceptionV3_decoder_dim_512_fine_tune_encoder_false_fine_false_embeddings_true-epoch-11.pth.tar"]
    output_path = ["show_tell_InceptionV3_decoder_dim_512_fine_tune_encoder_false_fine_false_embeddings_true"]
