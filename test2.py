...
if __name__ == '__main__':
    ...
    configs = dict()
    output_path2 = [
        "best_checkpoint_adaptive_Resnet101_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false-epoch-13.pth.tar"]
    output_path = ["adaptive_Resnet101_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false"]
