...
word_map_file = os.path.join(data_f,
                             "output/adaptive_DenseNet161_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true/wordmap.json")
...
def evaluate(encoder, decoder, caption_model, beam_size: int) -> float:
    ...
    loader = DataLoader(
        CaptionDataset(
            os.path.join(data_f,
                         'output/adaptive_DenseNet161_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true'),
            data_name, 'test',
...
if __name__ == '__main__':
    ...
    configs = dict()
    output_path2 = [
        "best_checkpoint_adaptive_DenseNet161_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false-epoch-23.pth.tar",
        "best_checkpoint_adaptive_DenseNet161_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true-epoch-34.pth.tar"]
