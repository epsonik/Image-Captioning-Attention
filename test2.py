...
if __name__ == '__main__':
    ...
    configs = dict()
    output_path = ["att2all_DenseNet201_decoder_dim_512_attention_dim_512_fine_tune_encoder_false_no_emb_all_stages",
                   "att2all_DenseNet201_decoder_dim_512_attention_dim_512_fine_tune_encoder_true_no_emb_all_stages"]
