...
def main():
    ...
    parser.add_argument("input", required=False, default="results.json", help="Plik wejściowy (zawierający 'imgToEval')")
    parser.add_argument("output", required=False, default="result2.json", help="Plik wyjściowy JSON (lista obiektów)")
