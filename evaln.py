...
def main():
    ...
    parser.add_argument("input", default="results.json", help="Plik wejściowy (zawierający 'imgToEval')")
    parser.add_argument("output", default="result2.json", help="Plik wyjściowy JSON (lista obiektów)")
