...
class config:
    ...
    output_path = "data/output/InceptionV3_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_false/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'InceptionV3_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_false'  # any name you want
    ...
    model_basename = 'InceptionV3_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_false'  # any name you want
    ...
    checkpoint = os.path.join(base_path, output_path,
                              'checkpoints/best_checkpoint_InceptionV3_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false-epoch-22.pth.tar')  # path to load checkpoint, None if none
    # checkpoint = None
