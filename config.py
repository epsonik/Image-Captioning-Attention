...
class config:
    ...
    output_path = "data/output/adaptive_att_InceptionV3_decoder_dim_512_attention_dim_512_fine_tune_encoder_true_fine_false_embeddings_true/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'adaptive_att_InceptionV3_decoder_dim_512_attention_dim_512_fine_tune_encoder_true_fine_false_embeddings_true'  # any name you want
    ...
    model_basename = 'adaptive_att_InceptionV3_decoder_dim_512_attention_dim_512_fine_tune_encoder_true_fine_false_embeddings_true'  # any name you want
    ...
    checkpoint = os.path.join(base_path, output_path,
                              'checkpoints/checkpoint_adaptive_att_InceptionV3_decoder_dim_512_attention_dim_512_fine_tune_encoder_false_fine_false_embeddings_false-epoch-29.pth.tar')  # path to load checkpoint, None if none
    # checkpoint = None
