...
class config:
    ...
    output_path = "data/output/DenseNet201_glove300_decoder_dim_128_attention_dim_128_ft_embeddings_false_fine_tune_encoder_true/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'DenseNet201_glove300_decoder_dim_128_attention_dim_128_ft_embeddings_false_fine_tune_encoder_true'  # any name you want
    ...
    model_basename = 'DenseNet201_glove300_decoder_dim_128_attention_dim_128_ft_embeddings_false_fine_tune_encoder_true'  # any name you want
    ...
    #                           'checkpoints/best_checkpoint_adaptive_DenseNet201_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false_fastText-epoch-19.pth.tar')  # path to load checkpoint, None if none
    checkpoint = None
