...
class config:
    ...
    output_path = "data/output/Resnet101_glove300_fte_false/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'Resnet101_glove300_fte_false'  # any name you want
    ...
    model_basename = 'Resnet101_glove300_fte_false'  # any name you want
    ...
    checkpoint = os.path.join(base_path, output_path, 'checkpoints/best_checkpoint_Resnet101_glove300_fte_false.pth.tar')  # path to load checkpoint, None if none
    # checkpoint = None
