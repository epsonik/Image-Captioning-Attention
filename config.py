...
class config:
    ...
    checkpoint = os.path.join(base_path, output_path, 'checkpoints/checkpoint_DenseNet201_glove300_fte_false_decoder_dim_256.pth.tar')  # path to load checkpoint, None if none
    # checkpoint = None
