...
class config:
    ...
    dataset_basename = 'Resnet101_glove300_decoder_dim_256_ft_embeddings_false_fine_tune_encoder_true'  # any name you want
    ...
    model_basename = 'Resnet101_glove300_decoder_dim_256_ft_embeddings_false_fine_tune_encoder_true'  # any name you want
    ...
    checkpoint = os.path.join(base_path, output_path,
                              'checkpoints/checkpoint_Resnet101_glove300_decoder_dim_256_ft_embeddings_false_fine_tune_encoder_false.pth.tar')  # path to load checkpoint, None if none
    # checkpoint = None
