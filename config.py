...
class config:
    ...
    output_path = "data/output/DenseNet201_glove300_fte_false/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'DenseNet201_glove300_fte_false'  # any name you want
    ...
    model_basename = 'DenseNet201_glove300_fte_false'  # any name you want
