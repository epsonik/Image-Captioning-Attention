...
class config:
    ...
    output_path = "data/output/adaptive_Resnet101_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'adaptive_Resnet101_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true'  # any name you want
    ...
    model_basename = 'adaptive_Resnet101_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true'  # any name you want

    # training parameters
    epochs = 50
    batch_size = 25
    pretrained_encoder = 'Resnet101'  # DenseNet201 Resnet101 Regnet32 DenseNet121 DenseNet161 Resnet152
    ...
    checkpoint = os.path.join(base_path, output_path,
                              'checkpoints/checkpoint_adaptive_Resnet101_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false-epoch-29.pth.tar')  # path to load checkpoint, None if none
    # checkpoint = None
