...
class config:
    ...
    output_path = "data/output/att2all_DenseNet161_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'att2all_DenseNet161_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false'  # any name you want
    ...
    model_basename = 'att2all_DenseNet161_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false'  # any name you want
