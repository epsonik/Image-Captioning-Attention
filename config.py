...
class config:
    ...
    output_path = "data/output/spatial_Resnet152_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'spatial_Resnet152_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true'  # any name you want
    ...
    model_basename = 'spatial_Resnet152_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true'  # any name you want

    # training parameters
    epochs = 50
    batch_size = 40
    pretrained_encoder = 'Resnet152'  # DenseNet201 Resnet101 Regnet32 DenseNet121 DenseNet161 Resnet152 InceptionV3
    ...
    checkpoint = os.path.join(base_path, output_path,
                              'checkpoints/checkpoint_spatial_Resnet152_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false-epoch-29.pth.tar,362395498,1717559903000')  # path to load checkpoint, None if none
    # checkpoint = None
