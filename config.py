...
class config:
    ...
    output_path = "data/output/adaptive_DenseNet121_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false_t/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'adaptive_DenseNet121_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false_t'  # any name you want
    ...
    model_basename = 'adaptive_DenseNet121_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false_t'  # any name you want
