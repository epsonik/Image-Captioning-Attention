...
class config:
    ...
    output_path = "data/output/Resnet101_glove300_decoder_dim_256_ft_embeddings_false_fine_tune_encoder_false/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'Resnet101_glove300_decoder_dim_256_ft_embeddings_false_fine_tune_encoder_false'  # any name you want
    ...
    model_basename = 'Resnet101_glove300_decoder_dim_256_ft_embeddings_false_fine_tune_encoder_false'  # any name you want
