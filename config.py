...
class config:
    ...
    output_path = "data/output/spatial_DenseNet121_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'spatial_DenseNet121_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true'  # any name you want
    ...
    model_basename = 'spatial_DenseNet121_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true'  # any name you want

    # training parameters
    epochs = 50
    batch_size = 40
    pretrained_encoder = 'DenseNet121'  # DenseNet201 Resnet101 Regnet32 DenseNet121 DenseNet161 Resnet152 InceptionV3
