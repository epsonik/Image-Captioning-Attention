...
class config:
    ...
    output_path = "data/output/InceptionV3_decoder_dim_512_fine_tune_encoder_tru_fine_tune_embeddings_false/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'InceptionV3_decoder_dim_512_fine_tune_encoder_tru_fine_tune_embeddings_false'  # any name you want
    ...
    model_basename = 'InceptionV3_decoder_dim_512_fine_tune_encoder_tru_fine_tune_embeddings_false'  # any name you want
