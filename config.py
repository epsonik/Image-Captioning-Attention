...
class config:
    ...
    dataset_basename = 'spatial_DenseNet121_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false'  # any name you want
    ...
    model_basename = 'spatial_DenseNet121_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false'  # any name you want
