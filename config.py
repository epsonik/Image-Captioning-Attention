...
class config:
    ...
    output_path = "data/output/adaptive_DenseNet201_decoder_dim_512_attention_dim_128_fine_tune_encoder_false_no_emb_all_stages/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'adaptive_DenseNet201_decoder_dim_512_attention_dim_128_fine_tune_encoder_false_no_emb_all_stages'  # any name you want
    ...
    model_basename = 'adaptive_DenseNet201_decoder_dim_512_attention_dim_128_fine_tune_encoder_false_no_emb_all_stages'  # any name you want
