...
class config:
    ...
    output_path = "data/output/Resnet152_decoder_dim_512_fine_tune_embeddings_true/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'Resnet152_decoder_dim_512_fine_tune_embeddings_true'  # any name you want
