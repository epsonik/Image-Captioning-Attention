...
class config:
    ...
    output_path = "data/output/DenseNet201_glove300_fine_tune_encoder_false_decoder_dim_512/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'DenseNet201_glove300_fine_tune_encoder_false_decoder_dim_512'  # any name you want
