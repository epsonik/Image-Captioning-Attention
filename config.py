...
class config:
    ...
    output_path = "data/output/adaptive_Regnet16_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'adaptive_Regnet16_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false'  # any name you want
    ...
    model_basename = 'adaptive_Regnet16_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false'  # any name you want

    # training parameters
    epochs = 30
    batch_size = 300
    pretrained_encoder = 'Regnet16'  # DenseNet201 Resnet101 Regnet32 DenseNet121 DenseNet161 Resnet152 InceptionV3
