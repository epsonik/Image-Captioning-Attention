...
class config:
    ...
    checkpoint = os.path.join(base_path, output_path,
                              'checkpoints/best_checkpoint_DenseNet201_glove300_decoder_dim_128_ft_embeddings_false_fine_tune_encoder_false.pth.tar')  # path to load checkpoint, None if none
    # checkpoint = None
