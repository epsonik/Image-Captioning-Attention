...
class config:
    ...
    output_path = "data/output/DenseNet201_glove300_decoder_dim_512_attention_dim_128_ft_embeddings_true_fine_tune_encoder_false/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'DenseNet201_glove300_decoder_dim_512_attention_dim_128_ft_embeddings_true_fine_tune_encoder_false'  # any name you want
    ...
    model_basename = 'DenseNet201_glove300_decoder_dim_512_attention_dim_128_ft_embeddings_true_fine_tune_encoder_false'  # any name you want
