...
class config:
    ...
    output_path = "data/output/adaptive_DenseNet201_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true_fastText/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'adaptive_DenseNet201_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true_fastText'  # any name you want
    ...
    model_basename = 'adaptive_DenseNet201_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true_fastText'  # any name you want
