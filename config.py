...
class config:
    ...
    output_path = "data/output/spatial_Regnet16_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'spatial_Regnet16_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true'  # any name you want
    ...
    model_basename = 'spatial_Regnet16_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true'  # any name you want
    ...
    checkpoint = os.path.join(base_path, output_path,
                              'checkpoints/checkpoint_spatial_Regnet16_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false-epoch-29.pth.tar')  # path to load checkpoint, None if none
    # checkpoint = None
