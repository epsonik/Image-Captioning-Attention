...
class config:
    ...
    output_path = "data/output/adaptive_50_Densenet201_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'adaptive_50_Densenet201_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true'  # any name you want
    ...
    model_basename = 'adaptive_50_Densenet201_decoder_dim_512_fine_tune_encoder_true_fine_tune_embeddings_true'  # any name you want
