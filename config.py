...
class config:
    ...
    output_path = "data/output/spatial_att_DenseNet201_decoder_dim_512_attention_dim_512_fine_tune_encoder_false_fine_false_embeddings_false/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'spatial_att_DenseNet201_decoder_dim_512_attention_dim_512_fine_tune_encoder_false_fine_false_embeddings_false'  # any name you want
    ...
    model_basename = 'spatial_att_DenseNet201_decoder_dim_512_attention_dim_512_fine_tune_encoder_false_fine_false_embeddings_false'  # any name you want
