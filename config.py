...
class config:
    ...
    output_path = "data/output/spatial_DenseNet161_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'spatial_DenseNet161_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false'  # any name you want
    ...
    model_basename = 'spatial_DenseNet161_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false'  # any name you want

    # training parameters
    epochs = 30
    batch_size = 100
    pretrained_encoder = 'DenseNet161'  # DenseNet201 Resnet101 Regnet32 DenseNet121 DenseNet161 Resnet152 InceptionV3
    ...
    #                           'checkpoints/checkpoint_spatial_DenseNet121_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false-epoch-29.pth.tar')  # path to load checkpoint, None if none
    checkpoint = None
