...
class config:
    ...
    output_path = "data/output/Resnet101_glove300_fte_true_decoder_dim_256/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'Resnet101_glove300_fte_true_decoder_dim_256'  # any name you want
    ...
    model_basename = 'Resnet101_glove300_fte_true_decoder_dim_256'  # any name you want
    ...
    checkpoint = os.path.join(base_path, output_path, 'checkpoints/checkpoint_Resnet101_glove300_fte_false_decoder_dim_256.pth.tar')  # path to load checkpoint, None if none
    # checkpoint = None
