...
class config:
    ...
    #                           'checkpoints/Regnet32_glove300_decoder_dim_128_attention_dim_128_ft_embeddings_true_fine_tune_encoder_true.pth.tar')  # path to load checkpoint, None if none
    checkpoint = None
