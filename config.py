...
class config:
    ...
    output_path = "data/output/show_tell_InceptionV3_decoder_dim_1024_fine_tune_encoder_true_fine_tune_embeddings_true/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'show_tell_InceptionV3_decoder_dim_1024_fine_tune_encoder_true_fine_tune_embeddings_true'  # any name you want
    ...
    model_basename = 'show_tell_InceptionV3_decoder_dim_1024_fine_tune_encoder_true_fine_tune_embeddings_true'  # any name you want
    ...
    checkpoint = os.path.join(base_path, output_path,
                              'checkpoints/checkpoint_show_tell_InceptionV3_decoder_dim_1024_fine_tune_encoder_false_fine_tune_embeddings_false-epoch-49.pth.tar')  # path to load checkpoint, None if none
    # checkpoint = None
