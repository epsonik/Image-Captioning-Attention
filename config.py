...
class config:
    ...
    output_path = "data/output/show_tell_InceptionV3_decoder_dim_512_fine_tune_encoder_false_fine_false_embeddings_true/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'show_tell_InceptionV3_decoder_dim_512_fine_tune_encoder_false_fine_false_embeddings_true'  # any name you want
    ...
    model_basename = 'show_tell_InceptionV3_decoder_dim_512_fine_tune_encoder_false_fine_false_embeddings_true'  # any name you want
    ...
    #                           'checkpoints/checkpoint_att2all_Resnet152_decoder_dim_512_fine_tune_encoder_false_fine_false_embeddings_false-epoch-29.pth.tar')  # path to load checkpoint, None if none
    checkpoint = None
