...
class config:
    ...
    output_path = "data/output/att2all_50_DenseNet201_decoder_dim_512_attention_dim_128_fine_tune_encoder_true_fine_tune_embeddings_true/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'att2all_50_DenseNet201_decoder_dim_512_attention_dim_128_fine_tune_encoder_true_fine_tune_embeddings_true'  # any name you want
    ...
    model_basename = 'att2all_50_DenseNet201_decoder_dim_512_attention_dim_128_fine_tune_encoder_true_fine_tune_embeddings_true'  # any name you want
