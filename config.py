...
class config:
    ...
    output_path = "data/output/Resnet101_glove300_decoder_dim_128_ft_embeddings_false_fine_tune_encoder_true/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'Resnet101_glove300_decoder_dim_128_ft_embeddings_false_fine_tune_encoder_true'  # any name you want
    ...
    model_basename = 'Resnet101_glove300_decoder_dim_128_ft_embeddings_false_fine_tune_encoder_true'  # any name you want

    # training parameters
    epochs = 50
    batch_size = 200
    pretrained_encoder = 'Resnet101' #DenseNet201 Resnet101
    ...
    checkpoint = os.path.join(base_path, output_path,
                              'checkpoints/checkpoint_Resnet101_glove300_decoder_dim_128_ft_embeddings_false_fine_tune_encoder_false.pth.tar')  # path to load checkpoint, None if none
    # checkpoint = None
