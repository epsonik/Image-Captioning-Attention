...
class config:
    ...
    checkpoint = os.path.join(base_path, output_path, 'checkpoints/best_checkpoint_Resnet101_glove300_fte_false_decoder_dim_512.pth.tar')  # path to load checkpoint, None if none
    # checkpoint = None
