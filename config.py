...
class config:
    ...
    output_path = "data/output/spatial_InceptionV3_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false/"
    dataset_type = 'coco'
    # dataset parameters
    ...
    dataset_basename = 'spatial_InceptionV3_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false'  # any name you want
    ...
    model_basename = 'spatial_InceptionV3_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false'  # any name you want

    # training parameters
    epochs = 30
    batch_size = 500
    pretrained_encoder = 'InceptionV3'  # DenseNet201 Resnet101 Regnet32 DenseNet121 DenseNet161 Resnet152 InceptionV3
    ...
    #                           'checkpoints/best_checkpoint_adaptive_InceptionV3_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false-epoch-9.pth.tar')  # path to load checkpoint, None if none
    checkpoint = None
