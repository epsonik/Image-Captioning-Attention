...
class config:
    ...
    checkpoint = os.path.join(base_path, output_path,
                              'checkpoints/best_checkpoint_adaptive_DenseNet201_decoder_dim_512_fine_tune_encoder_false_fine_tune_embeddings_false-epoch-6.pth.tar')  # path to load checkpoint, None if none
    # checkpoint = None
